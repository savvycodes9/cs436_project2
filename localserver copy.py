...
class RRTable:
    # record: {id,name,type,result,ttl,static}
    def __init__(self):
        self.records = []
    ...
    def display_table(self):
        with self.lock:
            ...
            for r in self.records:
                ...
                print(f'{r["id"]},{r["name"]},{r["type"]},{r["result"]},{ttl},{r["static"]}')
    def __decrement_ttl(self):
        while True:
            with self.lock:
                ...
                for i,r in enumerate(self.records): r["id"]=i
...
def seed_authoritative_csusm(rr: RRTable):
    ...
    rr.add_record("csusm.edu","NS","ns.csusm.edu",None,True)
    rr.add_record("portal.csusm.edu","CNAME","www.csusm.edu",None,True)
